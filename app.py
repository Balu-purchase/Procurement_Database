...
# --- 2. FULL PAGE INDUSTRIAL IMAGE WITH SIDE LOGIN ---
if not st.session_state.auth:
    # Set a background image that covers the page area
    page_bg_img = '''
    <style>
    ...
    '''
    st.markdown(page_bg_img, unsafe_allow_ Harris=True)

    # Creating the side-login layout
    ...
    with col_login:
        ...
        with st.container(border=True):
            st.markdown("<h2 style='text-align: center; color: white;'>PORTAL LOGIN</h2>", unsafe_allow_html=True)
